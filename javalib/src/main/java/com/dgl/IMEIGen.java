...
//        System.out.print(strings.length);
    ...
    public static void changeOldNumber(String oldNum,String newNum){
        ...
        for (int i =0;i<chars2.length;i++){
            if(chars2[i]!=chars[i] && chars2[i]!='*'){
                chars[i] = chars2[i];
            }
        }
        oldNum = String.valueOf(chars);
...
//        for (int i=0; i<arrStr.length; i++) {
        ...
        System.out.println();
        for (int i=700; i<arrStr.length; i++) {
            if(!list.contains(arrStr[i])) {
                list.add(arrStr[i]);
                System.out.print(arrStr[i]+"、");
            }
...
//        System.out.print(newArrStr.length);
