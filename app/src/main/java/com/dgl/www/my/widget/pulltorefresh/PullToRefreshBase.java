...
import com.dgl.www.my.widget.pulltorefresh.internal.FlipLoadingLayout;
import com.dgl.www.my.widget.pulltorefresh.internal.LoadingLayout;
import com.dgl.www.my.widget.pulltorefresh.internal.RotateLoadingLayout;
import com.dgl.www.my.widget.pulltorefresh.internal.Utils;
import com.dgl.www.my.widget.pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public void addView(View child, int index, ViewGroup.LayoutParams params) {
		if (DEBUG) {
			Log.e(LOG_TAG, "addView: " + child.getClass().getSimpleName());
		}
	...
	public final void setMode(Mode mode) {
		if (mode != mMode) {
			if (DEBUG) {
				Log.e(LOG_TAG, "Setting mode to: " + mode);
			}
			mMode = mode;
			updateUIForMode();
		}
	...
	final void setState(State state, final boolean... params) {
		mState = state;
		if (DEBUG) {
			Log.e(LOG_TAG, "State: " + mState.name());
		}
