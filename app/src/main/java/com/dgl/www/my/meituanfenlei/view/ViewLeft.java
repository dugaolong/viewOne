package com.dgl.www.my.meituanfenlei.view;
...
import com.dgl.www.my.meituanfenlei.adapter.TextAdapter;
...
public class ViewLeft extends RelativeLayout implements ViewBaseAction{
	...
	@Override
	public void hide() {
		ToastUtil.showToast(mContext,"ViewLeft.hide");
	}

	@Override
	public void show() {
		ToastUtil.showToast(mContext,"ViewLeft.show");
	}
