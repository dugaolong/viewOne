...
public class ContactAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<String,List<PhoneContact>> map;
    //设置组视图的显示文字
    private List<String> generalsTypes =new ArrayList<String>();

    public ContactAdapter(Context context,
                          HashMap<String,List<PhoneContact>> map,List<String> generalsTypes ) {
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        PhoneContact phoneContact = (PhoneContact) getChild(groupPosition, childPosition);
        textView.setTextColor(Color.BLACK);
        textView.setText(phoneContact.getName().toString());
        return view;
    }
