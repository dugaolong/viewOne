...
import com.dgl.www.my.widget.pulltorefresh.internal.EmptyViewMethodAccessor;
import com.dgl.www.my.widget.pulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		if (DEBUG) {
			Log.e(LOG_TAG, "First Visible: " + firstVisibleItem + ". Visible Count: " + visibleItemCount
	...
	private boolean isFirstItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			if (DEBUG) {
				Log.e(LOG_TAG, "isFirstItemVisible. Empty View.");
			}
			return true;
	...
	private boolean isLastItemVisible() {
		...
		if (null == adapter || adapter.isEmpty()) {
			if (DEBUG) {
				Log.e(LOG_TAG, "isLastItemVisible. Empty View.");
			}
			return true;
		} else {
			...
			if (DEBUG) {
				Log.e(LOG_TAG, "isLastItemVisible. Last Item Position: " + lastItemPosition + " Last Visible Pos: "
						+ lastVisiblePosition);
			}
